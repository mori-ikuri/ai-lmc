...
' 2011/11/08 山田 タイの3つを追加
' 2012/02/13 山田 タイ納品入力とタイ納品一覧を追加
' 2013/05/13 山田 タイ締めを追加
'============================================================
Public Class frmMenu
    ...
    'タイ得意先登録
    '------------------------------------------------------------
    Private Sub btnThaiTokuisaki_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiTokuisaki.Click

        Dim f As frmThaiTokuisaki

        f = New frmThaiTokuisaki
        f.ShowDialog()
        f.Dispose()
    ...
    'タイ受注取込
    '------------------------------------------------------------
    Private Sub btnThaiTorikomi_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiTorikomi.Click

        Dim f As frmThaiTorikomi

        f = New frmThaiTorikomi
        f.ShowDialog()
        f.Dispose()
    ...
    'タイ受注一覧
    '------------------------------------------------------------
    Private Sub btnThaiJuchu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiJuchu.Click

        Dim f As frmThaiJuchu
    ...
    'タイ納品入力
    '------------------------------------------------------------
    Private Sub btnThaiNohin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiNohin.Click

        Dim f As frmThaiNohin
    ...
    'タイ納品一覧
    '------------------------------------------------------------
    Private Sub btnThaiNohinIchiran_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiNohinIchiran.Click

        Dim f As frmThaiNohinIchiran

        f = New frmThaiNohinIchiran
        f.ShowDialog()
        f.Dispose()
    ...
    'タイ締め
    '------------------------------------------------------------
    Private Sub btnThaiShime_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThaiShime.Click

        Dim f As frmThaiShime
